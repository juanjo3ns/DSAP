...
def funcio_2(): 
    items = mongo.get_from(filt={"city":"barcelona"})
    
    print("Hi ha: " + str(len(items)) + " registres")
    print("Hi ha: {} registres \n{}".format(len(items),7)) 
...
def funcio_3():
    item = mongo.get_from("id","0")
    name = item[0]["file_name"]
    print(name)
    #name = name.split(".")

    a = wav.read("/home/data/audio/" + str(name))
    print(a)
    print(a.data)
    print(a.rate)
    print(a.sampwidth)
